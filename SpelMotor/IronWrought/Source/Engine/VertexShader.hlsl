...
//uniform matrix gWVP;
//uniform matrix gWorld;
//uniform matrix gBones[MAX_BONES];
...
VertexToPixel main(VertexInput input)
{
   ...
   // returnValue.myColor = input.myNormal;
 ...
 //   float4 animView = mul(input.myPosition, view);
 //   float4 animProjection = mul(returnValue.myPosition, toProjection);
 //   returnValue.myPosition = animProjection;
 //   returnValue.myColor = input.myNormal;
