...
public class CopyAssetFolder : MonoBehaviour
{
    // Get everything in the Unity Assets folder
    // Replace everything but the .meta files

    [MenuItem("Tools/Copy Asset Folder #k")]
    static void CopyAssets()
    {
        string targetPath   = "..\\Bin\\Assets\\SG\\";// Engine Asset path, assumes Unity Project is in the same folder as Source,Bin and Lib.
        string unityPath    = "Assets\\SG\\";
