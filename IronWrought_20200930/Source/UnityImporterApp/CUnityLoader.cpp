...
std::vector<ObjectData> CUnityLoader::LoadGameObjectsASCII(const std::string& aGameObjectFile)
{
	...
	for (rapidjson::SizeType i = 0; i < results.Size(); i++)
	{
		...
		object.myCharacterData.myName			= std::string(results[i]["myCharacterData"]["myName"].GetString());
		object.myCharacterData.myHealth			= (results[i]["myCharacterData"]["myHealth"].GetDouble());
		object.myCharacterData.myDamage			= (results[i]["myCharacterData"]["myDamage"].GetDouble());
		object.myCharacterData.myMoveSpeed		= (results[i]["myCharacterData"]["myMoveSpeed"].GetDouble());
		object.myCharacterData.myAttackSpeed	= (results[i]["myCharacterData"]["myAttackSpeed"].GetDouble());
		object.myCharacterData.myCastSpeed		= (results[i]["myCharacterData"]["myCastSpeed"].GetDouble());
